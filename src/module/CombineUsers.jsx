import { getMonthYear } from '../components/getMonthYear';
import { filterDataByMonth } from '../components/filterDataByMonth';
import { sortDataByDate } from '../components/sortDataByDate'
import { useApi } from '../services/api';
import UsersMonthlyRewards from './UsersMonthlyRewards'
...
export function CombineUsers() {
  ...
  return (
    <>
      ...
      <UsersMonthlyRewards sortedDate={thirdLatestData} month={thirdlatest.month} year={thirdlatest.year} />
      <UsersMonthlyRewards sortedDate={secondLatestData} month={secondlatest.month} year={secondlatest.year} />
      <UsersMonthlyRewards sortedDate={latestData} month={latest.month} year={latest.year} />
    </>
  )
}
